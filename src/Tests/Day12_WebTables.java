...
public class Day12_WebTables extends TestBase {
   ...
   private static Logger logger = LogManager.getLogger(Day12_WebTables.class.getName());
    ...
    public void printTableData() {
        ...
        List<WebElement> listOfAllElements = driver.findElements(By.xpath("//table[@id='table1']//tbody//tr//td"));
        for (WebElement w : listOfAllElements) {
            System.out.println(w.getText());
        }
        System.out.println("5th DATA in the table " + listOfAllElements.get(5).getText());
    }
...
//        Task 3 : Print Last row data only
    ...
    public void printData(int rowNum, int colNum){
       ...
       String element = driver.findElement(By.xpath(xpath)).getText();
        System.out.println(rowNum + "nd Row ," +colNum+"nd Column => "+element);
