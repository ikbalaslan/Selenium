...
//    THE POINT OF REUSABLE METHOD IS : WRITE ONCE USE MULTIPLE TIMES TO SAVE TIME AND SHORT TEST CLASS
    public static void searchAndSelectFromList(String keyword, String textFromList){
       ...
       // Nothing special. Just clicking on a submit button
        driver.findElement(By.xpath("//input[@type='button']")).click();//click on a submit button
       //If result contains my option that i selected Dynamically using parameter 2
...
-sendKeys()
-with javascript executor we change the value of the input
