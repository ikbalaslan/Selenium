...
public class Q03 {
    ...
    public void t() throws InterruptedException {
         ...
         driver.findElement(By.xpath("//*[@value='read']")).click();
         ...
         driver.findElement(By.xpath("//*[@placeholder='Enter PhoneNumber']")).sendKeys("12345");
         ...
         driver.findElement(By.id("comment")).sendKeys("My name is John Doe. I am a famous man.");
